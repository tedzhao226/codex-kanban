...
- [ ] Choose and document a license before calling the repository open-source licensed. No license grant or identifier is selected yet.
- [ ] Decide the public repository location.
